-- =============================================================================
-- 0044 — ÖĞRENCİ LİSTELERİ OKUL NUMARASINA GÖRE
--
-- NE İSTENDİ
-- Öğretmen: "sınıflara tıkladığınızda o sınıftaki öğrencilerin öğrenci
-- numarasına göre sıralansın — küçükten büyüğe."
--
-- Bugüne kadar bütün listeler ADA göre sıralıydı. Yoklama alırken, kâğıt
-- dağıtırken ve e-Okul listesiyle karşılaştırırken sıra tutmuyordu.
--
-- KAPSAM (öğretmenin kararı): sınıf detayı · Kodlar · Kod fişleri.
-- `Öğrenciler` ekranı ADA göre kalıyor: orada sınıf seçilmeden
-- bakıldığında farklı sınıfların aynı numaraları iç içe geçerdi.
--
-- SIRALAMA SUNUCUDA. `ogrenciler_listesi` sayfalı; istemcide sıralansaydı
-- yalnız o sayfanın içi sıralanır, sayfalar arası karışırdı.
-- =============================================================================

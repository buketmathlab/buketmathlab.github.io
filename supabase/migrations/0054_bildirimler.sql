-- =============================================================================
-- 0054 — BİLDİRİMLER: uygulama içi bildirim merkezi
--
-- Öğretmenin isteği: "Onaylıyorum ve her mesajda, ödev verildiğinde, ödev
-- teslimi yaklaştığında, ödev sonucu açıklandığında öğrenciye bildirim
-- gitsin."
--
-- Bugüne kadar öğrenci ve veli YALNIZ mesaj için bir işaret görüyordu
-- (sekmedeki `okunmamis_mesaj` rozeti, 0025). Öbür üç olay hiçbir yerde
-- haber verilmiyordu.
--
-- -----------------------------------------------------------------------------
-- ÖĞRETMENİN DÖRT KARARI
--
--   1. KANAL: önce uygulama içi (zil + liste + rozet). Telefon bildirimi
--      ayrı tur — ve teknik olarak bugün mümkün değil: serviste çalışan
--      (service worker) bilerek yok ve `pwa-denetimi.mjs` her koşuda
--      YOKLUĞUNU ölçüyor.
--   2. KİM ALSIN: öğrenci dördünü, veli üçünü. Veliye "teslim yaklaşıyor"
--      GİTMİYOR.
--   3. TESLİM HATIRLATMASI: son günden 1 gün önce.
--   4. SONUÇ BİLDİRİMİ: öğretmen puanı verince; test ödevinde gitmiyor.
--
-- -----------------------------------------------------------------------------
-- DEFTER YOK — BİLDİRİMLER TÜRETİLİYOR
--
-- En beklenen tasarım bir `bildirimler` tablosu yazıp dört ucun (mesaj
-- gönder, ödev yayınla, puanla, zamanlayıcı) içine satır eklemekti.
-- Yapılmadı, sebebi tek cümlede: DEFTER YALAN SÖYLEYEBİLİR, TÜRETME
-- SÖYLEYEMEZ.
--
...
--   • Öğrenci ödevini gönderirse "teslimi yarın" hatırlatması
--     kendiliğinden kaybolur; defterde onu silmek için İKİNCİ BİR YAZICI
--     gerekirdi.
--   • Dört ayrı ucun gövdesine dokunmak gerekmiyor (0022'nin kuralı).
--   • ZAMANLAYICIYA HİÇ GEREK KALMIYOR: "teslimi yarın" satırı, o gün
--     geldiğinde sorgunun sonucunda kendiliğinden var oluyor. (pg_cron
--     zaten kurulu değil.)
--
-- BEDELİ DÜRÜSTÇE: türetme "bu bildirimi gönderdik" kaydı tutmuyor.
-- Telefon bildirimi turunda o kayıt gerekecek (aynı bildirimi iki kez
-- itmemek için) ve o zaman BU SORGUNUN ÜSTÜNE bir gönderim defteri
-- gelecek — bu turun işi çöpe gitmiyor, olayın ne olduğuna karar veren
-- yer burası kalıyor.
-- =============================================================================

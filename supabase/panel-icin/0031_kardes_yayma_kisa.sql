...
-- Açıklamalı tam sürüm: supabase/migrations/0031_kardes_yayma.sql
--
-- Çalıştırılmazsa hiçbir şey bozulmaz: yayma düğmesi ekranda hiç çıkmaz,
-- ödev düzenleme bugünkü gibi çalışır.
